 ...
 * @version: 1.0
 */
@TableName(value="t_customer_view_history",resultMap="BaseResultMap")
public class CustomerViewHistory extends Model<CustomerViewHistory> {
     ...
     * 浏览者
     */
	@TableField(value="view_user_id", el="viewUser.id")
