...
! function(t, e) {
	...
	function A(t) {
		...
		for(Pi = t, Mi = zi = !1, Ii = Ui = qi = 0, Vi = 0, Ri = {}, Bi = 0, Li = Pi.length; Li > Bi; Bi++)
			if(Wi = Hi, Hi = Pi.charCodeAt(Bi), Mi) 39 === Hi && 92 !== Wi && (Mi = !Mi);
	...
	function ie(t) {
		...
		if(Tr) {
			...
			if(Yt(t) && (t = t.content, s = r.content), i = t.querySelectorAll("template"), i.length)
				for(n = s.querySelectorAll("template"), e = n.length; e--;) n[e].parentNode.replaceChild(ie(i[e]), n[e])
		}
		if(Er)
	...
	function $e(t) {
		return function(e, i) {
			...
			for(var n, r, s, l, c, u = t.length; u--;)
				if(n = t[u], c = n.raw, r = n.path, s = n.options, e._props[r] = n, null === c) lt(e, n, ke(e, s));
	...
	function Ue(t, e) {
		...
		for(var n, r, s, o, a, h, l, c, u, f, p = t.length, d = []; p--;)
			if(n = t[p], r = o = n.name, s = a = n.value, f = j(s), l = null, c = qe(r), r = r.replace(ss, ""), f) s = T(f), "class" === r ? i("class", Xr["class"], !0) : (l = r, i("bind", Br.bind, !0));
	...
	ei.prototype._bind = function() {
		...
		if(this._bound) {
			...
			if(e)
				for(t = e.length; t--;) Z(this.el, e[t][0], e[t][1]);
