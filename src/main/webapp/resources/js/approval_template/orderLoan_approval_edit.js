...
var orderLoan_approval_edit = {
    init: function (params) {
        orderLoan_approval_edit.initBasic();
        orderLoan_approval_edit.initApprovalDialog();
        orderLoan_approval_edit.initBtn();
    },
    initBasic:function () {
        ...
        orderLoan_approval_edit.initCsAssistantDialog("#csAssistantIdEdit");
        orderLoan_approval_edit.initCsPrincipalDialog("#csPrincipalIdEdit");
        orderLoan_approval_edit.initFollowUserDialog("#followUserIdEdit");
        orderLoan_approval_edit.initOwnerDialog("#ownerIdEdit");
        //基本信息初始化
        ...
        orderLoan_approval_edit.initMatchmakerDialog("#matchmakerId");
        ...
        //借款初始化
        var url=ctx + "/myWorkbench/orderLoan/selectOneById.jhtml";
        var loandata = CSIT.syncCallService(url, {"orderLoanId":orderLoanId});
        $("#LoanForm").form('clear');
        $("#LoanForm").form('load',loandata);
    ...
    initBtn:function(){
        ...
        //弹窗按钮
        //客户
        orderLoan_approval_edit.initDialogClick("#customerNameEdit","#customerDialog",
            "#customerDialogList","#searchCustomerBtn","#searchCustomerForm");
        //客户助理
        orderLoan_approval_edit.initDialogClick("#csAssistantIdEdit","#csAssistantDialog",
            "#csAssistantDialogList","#searchCsAssistantBtn","#csAssistantForm");
        //客服负责人
        orderLoan_approval_edit.initDialogClick("#csPrincipalIdEdit","#csPrincipalDialog",
            "#csPrincipalDialogList","#searchCsPrincipalBtn","#csPrincipalForm");
        //跟单人
        orderLoan_approval_edit.initDialogClick("#followUserIdEdit","#followUserDialog",
            "#followUserDialogList","#searchFollowUserBtn","#followUserForm");
        //拥有人
        orderLoan_approval_edit.initDialogClick("#ownerIdEdit","#ownerDialog",
            "#ownerDialogList","#searchOwnerBtn","#ownerForm");
        //介绍人
        orderLoan_approval_edit.initDialogClick("#matchmakerId","#matchmakerDialog",
        ...
        $("#branchId").textbox({
            onClickIcon: function (index) {
                ...
                orderLoan_approval_edit.initBranchDialog("#branchId");
        ...
        //表单提交初始化
        orderLoan_approval_edit.initEditFormDialog("#editModForm");
        orderLoan_approval_edit.initEditFormDialog("#editLoanForm");
        orderLoan_approval_edit.initEditFormDialog("#LoanForm");
        //保存按钮
    ...
    initApprovalDialog:function(){
        ...
        $("#orderPropertyList").datagrid({
            ...
            border:false,
            toolbar: [
                {iconCls: 'icon-add',text:'添加',handler: function(){orderLoan_approval_edit.selectProperty();}},
                {iconCls: 'icon-remove',text:'删除',handler: function(){
                    orderLoan_approval_edit.deleteBtn("#orderPropertyList",ctx + "/myWorkbench/orderProperty/mulDelete.jhtml");
                }},
            ],
            ctrlSelect:true,
            rownumbers:true,
        ...
        if(orderAuditStatus!=1){
            $("#orderPropertyList").datagrid({toolbar: []});
        }
        //审批历史
    ...
    selectProperty:function(){
        orderLoan_approval_edit.initPropertyEditDialog();
