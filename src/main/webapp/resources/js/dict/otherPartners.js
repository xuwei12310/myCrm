var otherPartners = {
    ...
    init: function (params) {
    	otherPartners.initEditDialog();
    	otherPartners.initCRUDBtn();
    	otherPartners.initViewList({
			columns : [ [ {
				field : 'ck',
				checkbox : true
			},
