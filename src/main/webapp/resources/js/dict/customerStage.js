var customerStage = {
	...
	initCRUDBtn:function(){
    	...
    	$(app.id.deleteBtnId).click(function(){
    		customerStage.mulDelete();
    	});
    	//查询
    	$(app.id.searchBtnId).click(function(){
    		customerStage.search();
    	});
    	//清空查询条件
    ...
    init: function (params) {
    	customerStage.initEditDialog();
    	customerStage.initCRUDBtn();
    	customerStage.initViewList({
			columns : [ [ {
				field : 'ck',
				checkbox : true
			},
