var relatedMaterials = {
    ...
    change:function(direction){
		...
		var number=selectRow.number==undefined?'':selectRow.number;
		var code=selectRow.code==undefined?'':selectRow.code;
    ...
    init: function (params) {
    	relatedMaterials.initEditDialog();
    	relatedMaterials.initCRUDBtn();
    	relatedMaterials.initViewList({
			columns : [ [ {
				field : 'ck',
				checkbox : true
			},
