var customerStatus = {
	...
	initCRUDBtn:function(){
    	...
    	$(app.id.deleteBtnId).click(function(){
    		customerStatus.mulDelete();
    	});
    	//查询
    	$(app.id.searchBtnId).click(function(){
    		customerStatus.search();
    	});
    	//清空查询条件
    ...
    init: function (params) {
    	customerStatus.initEditDialog();
    	customerStatus.initCRUDBtn();
    	customerStatus.initViewList({
			columns : [ [ {
				field : 'ck',
				checkbox : true
			},
