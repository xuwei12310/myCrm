var housingNature = {
	...
	init : function(params) {
		housingNature.initEditDialog();
		housingNature.initCRUDBtn();
		housingNature.initViewList({
			columns : [ [ {
				field : 'ck',
				checkbox : true
			},
