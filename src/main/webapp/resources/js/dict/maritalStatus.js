var maritalStatus = {
	...
	initCRUDBtn : function() {
		...
		$(app.id.deleteBtnId).click(function() {
			maritalStatus.mulDelete();
		});
		// 查询
		$(app.id.searchBtnId).click(function() {
			maritalStatus.search();
		});
		// 清空查询条件
	...
	init : function(params) {
		maritalStatus.initEditDialog();
		maritalStatus.initCRUDBtn();
		maritalStatus.initViewList({
			columns : [ [ {
				field : 'ck',
				checkbox : true
			},
