var customerSource = {
	...
	init : function(params) {
		customerSource.initEditDialog();
		customerSource.initCRUDBtn();
		customerSource.initViewList({
			columns : [ [ {
				field : 'ck',
				checkbox : true
			},
