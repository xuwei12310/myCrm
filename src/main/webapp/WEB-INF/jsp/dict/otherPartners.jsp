...
<%
  request.setAttribute("resourceIdentity", "dict:otherPartners");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
		var ctx = "${ctx}";
		var resourceName = "其他合作伙伴";
		var resourcePath = "/dict/otherPartners";
  </script> 
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/otherPartners.js"></script>
  <script type="text/javascript">
	$(function () {
		otherPartners.init();
	})
