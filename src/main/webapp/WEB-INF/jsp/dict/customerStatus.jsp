...
<%
  request.setAttribute("resourceIdentity", "dict:customerStatus");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
		var ctx = "${ctx}";
		var resourceName = "客户状态";
		var resourcePath = "/dict/customerStatus";
  </script> 
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/customerStatus.js"></script>
  <script type="text/javascript">
	$(function () {
		customerStatus.init();
	})
...
<body class="easyui-layout">
	<div data-options="region:'north',border:false" class="searchDiv">
		<form id="searchForm" method="post">
			...
			<input class="easyui-textbox" name="name" style="width:180px" data-options="label:'状态名称',labelWidth:70">
