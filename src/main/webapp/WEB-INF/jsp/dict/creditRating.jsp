...
<%
  request.setAttribute("resourceIdentity", "dict:creditRating");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
        var ctx = "${ctx}";
        var resourceName = "信用等级";
        var resourcePath = "/dict/creditRating";
  </script>
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/creditRating.js"></script>
  <script type="text/javascript">
    $(function () {
        creditRating.init();
    })
