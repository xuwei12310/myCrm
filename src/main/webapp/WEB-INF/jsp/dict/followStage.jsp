...
<%
  request.setAttribute("resourceIdentity", "dict:followStage");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
		var ctx = "${ctx}";
		var resourceName = "跟进阶段";
		var resourcePath = "/dict/followStage";
  </script>
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/followStage.js"></script>
  <script type="text/javascript">
	$(function () {
		followStage.init();
	})
