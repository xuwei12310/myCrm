...
<%
  request.setAttribute("resourceIdentity", "dict:payType");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
		var ctx = "${ctx}";
		var resourceName = "付款方式";
		var resourcePath = "/dict/payType";
  </script>
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/payType.js"></script>
  <script type="text/javascript">
	$(function () {
		payType.init();
	})
