...
<%
  request.setAttribute("resourceIdentity", "dict:costType");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
		var ctx = "${ctx}";
		var resourceName = "费用类型";
		var resourcePath = "/dict/costType";
  </script>
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/costType.js"></script>
  <script type="text/javascript">
	$(function () {
		costType.init();
	})
