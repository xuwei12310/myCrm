...
<%
  request.setAttribute("resourceIdentity", "dict:maritalStatus");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
		var ctx = "${ctx}";
		var resourceName = "婚姻状况";
		var resourcePath = "/dict/maritalStatus";
  </script> 
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/maritalStatus.js"></script>
  <script type="text/javascript">
	$(function () {
		maritalStatus.init();
	})
