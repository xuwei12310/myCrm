...
<%
  request.setAttribute("resourceIdentity", "dict:customerSource");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
		var ctx = "${ctx}";
		var resourceName = "客户来源";
		var resourcePath = "/dict/customerSource";
  </script>
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/customerSource.js"></script>
  <script type="text/javascript">
	$(function () {
		customerSource.init();
	})
...
<body class="easyui-layout">
	<div data-options="region:'north',border:false" class="searchDiv">
		<form id="searchForm" method="post">
			...
			<input class="easyui-textbox" name="name" style="width:180px" data-options="label:'来源名称',labelWidth:70">
