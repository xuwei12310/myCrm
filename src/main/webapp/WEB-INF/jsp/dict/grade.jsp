...
<%
  request.setAttribute("resourceIdentity", "dict:grade");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
        var ctx = "${ctx}";
        var resourceName = "智能评级";
        var resourcePath = "/dict/grade";
  </script>
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/grade.js"></script>
  <script type="text/javascript">
    $(function () {
        grade.init();
    })
