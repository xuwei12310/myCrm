...
<%
  request.setAttribute("resourceIdentity", "dict:repayWay");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
		var ctx = "${ctx}";
		var resourceName = "还款方式";
		var resourcePath = "/dict/repayWay";
  </script>
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/repayWay.js"></script>
  <script type="text/javascript">
	$(function () {
		repayWay.init();
	})
