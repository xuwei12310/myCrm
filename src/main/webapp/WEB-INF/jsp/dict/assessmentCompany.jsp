...
<%
  request.setAttribute("resourceIdentity", "dict:assessmentCompany");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
		var ctx = "${ctx}";
		var resourceName = "评估公司";
		var resourcePath = "/dict/assessmentCompany";
  </script> 
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/assessmentCompany.js"></script>
  <script type="text/javascript">
	$(function () {
		assessmentCompany.init();
	})
  </script>
</head>
<body class="easyui-layout">
	<div data-options="region:'north',border:false" class="searchDiv">
		<form id="searchForm" method="post">
			...
			<input class="easyui-textbox" name="name" style="width:180px" data-options="label:'公司名称',labelWidth:70">
		...
		<form id="editForm" method="post">
			...
			<table class="contentTb">
				...
				<tr>
					...
					<td class="tdContent">
						<input class="easyui-textbox contentInput" name="telephone"  data-options="validType:'mobile'">
					</td>
				</tr>
				<tr>
