...
<%
  request.setAttribute("resourceIdentity", "dict:relatedMaterials");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
		var ctx = "${ctx}";
		var resourceName = "相关材料";
		var resourcePath = "/dict/relatedMaterials";
  </script> 
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/relatedMaterials.js"></script>
  <script type="text/javascript">
	$(function () {
		relatedMaterials.init();
	})
  </script>
</head>
		...
		<form id="editForm" method="post">
			...
			<table class="contentTb">
				<tr>
					...
					<td class="tdContent">
						<input class="easyui-textbox contentInput" name="code"  data-options="required:true">
					</td>
				</tr>
				<tr>
					<td class="tdTitle">材料名称：</td>
					<td class="tdContent">
						<input class="easyui-textbox contentInput" name="name"  data-options="required:true">
					</td>
				</tr>
				<tr>
					<td class="tdTitle">注意事项：</td>
					<td class="tdContent">
						<input class="easyui-textbox contentInput" name="note"  >
					</td>
				</tr>
				<tr>
					<td class="tdTitle">份数：</td>
					<td class="tdContent">
						<input class="easyui-numberbox contentInput" name="number" >
					</td>
				</tr>
				<tr>
