...
<%
  request.setAttribute("resourceIdentity", "dict:landNature");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
		var ctx = "${ctx}";
		var resourceName = "土地性质";
		var resourcePath = "/dict/landNature";
  </script>
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/landNature.js"></script>
  <script type="text/javascript">
	$(function () {
		landNature.init();
	})
