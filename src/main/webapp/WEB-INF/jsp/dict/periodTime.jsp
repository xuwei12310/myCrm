...
<%
  request.setAttribute("resourceIdentity", "dict:periodTime");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
		var ctx = "${ctx}";
		var resourceName = "期次";
		var resourcePath = "/dict/periodTime";
  </script>
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/periodTime.js"></script>
  <script type="text/javascript">
	$(function () {
		periodTime.init();
	})
