...
<%
  request.setAttribute("resourceIdentity", "dict:customerStage");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
		var ctx = "${ctx}";
		var resourceName = "客户阶段";
		var resourcePath = "/dict/customerStage";
  </script> 
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/customerStage.js"></script>
  <script type="text/javascript">
	$(function () {
		customerStage.init();
	})
...
<body class="easyui-layout">
	<div data-options="region:'north',border:false" class="searchDiv">
		<form id="searchForm" method="post">
			...
			<input class="easyui-textbox" name="name" style="width:180px" data-options="label:'阶段名称',labelWidth:70">
