...
<%
  request.setAttribute("resourceIdentity", "dict:housingNature");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
		var ctx = "${ctx}";
		var resourceName = "房屋性质";
		var resourcePath = "/dict/housingNature";
  </script>
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/dict/housingNature.js"></script>
  <script type="text/javascript">
	$(function () {
		housingNature.init();
	})
