...
<%
  request.setAttribute("resourceIdentity", ":roleResources");
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <script type="text/javascript">
		var ctx = "${ctx}";
		var resourceName = "";
		var resourcePath = "/admin/roleResources";
  </script>
  <%@include file="/WEB-INF/jsp/common/js.jsp"%>
  <script type="text/javascript" src="${ctx}/resources/js/common/crud.js"></script>
  <script type="text/javascript" src="${ctx}/resources/js/admin/roleResources.js"></script>
  <script type="text/javascript">
	$(function () {
		roleResources.init();
	})
...
<body class="easyui-layout">
	<div data-options="region:'north',border:false" class="searchDiv">
		<form id="searchForm" method="post">
					...
					<input class="easyui-textbox" name="resourcesId" style="width:180px" data-options="label:'',labelWidth:70">
		...
		<form id="editForm" method="post">
            ...
            <table >
				...
				<tr>
					<td class="tdFirstTitle"></td>
					<td class="tdFirstContent">
						<input class="easyui-textbox" id="resourcesId" name="resourcesId" style="width:100%" data-options="required:true">
					</td>
				</tr>
			            </table>
		</form>
