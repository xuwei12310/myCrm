...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>基础配置 <span class="c-gray en">&gt;</span> 区县管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<form action="district" method="get">
		...
		<div class="text-c">区县名:
			<input type="text" class="input-text" value="${districtName }" 
					style="width: 250px;" placeholder="请输入区县名" id="districtName" name="districtName" />
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		 ...
		 <a href="javascript:;" onclick="member_add('添加区县','district?oper=insert','','510')" 
		 	class="btn btn-primary radius">
		 <i class="Hui-iconfont">&#xe600;</i> 添加区县</a></span> 
	...
	<table id="datalist" class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<c:forEach var="item" items="${DataList}">
				<tr class="text-c">
					<td><input type="checkbox" value="${item.districtId }" name="" ></td>
					...
					<td class="td-manage">
						...
						<a title="编辑" href="javascript:;" 
							onclick="member_edit('编辑【区县：${item.districtName }】','district?oper=update&pk=${item.districtId}','4','','510')" class="ml-5" 
							style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
						<a title="查看" href="javascript:;" 
							onclick="member_detail('查看【区县：${item.districtName }】','district?oper=detail&pk=${item.districtId}','4','','510')" class="ml-5" 
							style="text-decoration:none"><i class="Hui-iconfont">&#xe667;</i></a> 
						
						<a title="删除" href="javascript:;" onclick="member_del(this,${item.districtId})" class="ml-5" 
							style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
					</td>
...
$(function(){
	...
	$("#clearSearch").click(function(){
		location.href="district?oper=list&pageindex=${pagerItem.pageIndex}&pagesize=${pagerItem.pageSize }";
	});
