...
<article class="page-container">
	<form action="${pageContext.request.contextPath }/coreUser/update.jhtml" method="post" class="form form-horizontal" id="form-member-update">
		<input type="hidden" name="userid" value="${user.userid }" >
		<input type="hidden" name="pk" value="${user.userid  }" >
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.telno }" placeholder="" id="telNo" name="telno">
			</div>
		</div>
...
$(function(){
	...
	$("#form-member-update").submit(function(){
		var vIsOk=checkForm();
		return vIsOk;
	}); 
});
...
function checkForm(){
	var result=$("#form-member-update").validate({
		rules:{
			userName:{
				required:true
			},
