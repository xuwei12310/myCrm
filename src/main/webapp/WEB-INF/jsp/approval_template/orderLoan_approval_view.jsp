...
<head>
  ...
  <script type="text/javascript" src="${ctx}/resources/js/approval_template/orderLoan_approval_view.js"></script>
  <script type="text/javascript">
	$(function () {
        orderLoan_approval_view.init();
	})
  </script>
</head>
						...
						<form id="LoanForm" method="post">
							<table>
								...
								<tr>
									...
									<td class="tdFirstContent">
										<input class="easyui-numberbox" name="rate" style="width:100%" data-options="editable:false">
									</td>
								</tr>
								<tr>
									<td class="tdFirstTitle">借款日期</td>
									<td class="tdFirstContent">
										<input class="easyui-textbox" name="beginDate" style="width:100%" data-options="editable:false">
									</td>
								</tr>
								<tr>
									<td class="tdFirstTitle">预计还款日期</td>
									<td class="tdFirstContent">
										<input class="easyui-textbox" name="estimateRepayDate" style="width:100%"
											   data-options="editable:false">
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="tdFirstContent">
										<input class="easyui-textbox" style="width:100%" name="repayDate"
											   data-options="editable:false">
									</td>
								</tr>
								<tr>
