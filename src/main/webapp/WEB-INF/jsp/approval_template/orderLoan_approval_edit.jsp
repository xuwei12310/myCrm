...
<head>
  ...
  <script type="text/javascript" src="${ctx}/resources/js/approval_template/orderLoan_approval_edit.js"></script>
  <script type="text/javascript">
	$(function () {
        orderLoan_approval_edit.init();
	})
  </script>
</head>
		...
		<div id="infoTabs" class="easyui-tabs" data-options="fit:true,border:false">
						...
						<form id="editModForm" method="post" action="${ctx}/myWorkbench/order/update.jhtml">
							...
							<table>
								...
								<tr>
									...
									<td class="tdFirstContent">
										<input class="easyui-textbox" id="productIdEdit" style="width:100%" data-options="required:true">
									</td>
								</tr>
								<tr>
			...
			<div title="借款">
				<div class="easyui-layout" data-options="fit:true,selected:true">
					...
					<div data-options="region:'center',border:false">
						<form id="LoanForm" method="post" action="${ctx}/myWorkbench/orderLoan/update.jhtml">
							<input type="hidden" id="LoanOrderId" name="order.id" value="${orderId}">
							<input type="hidden" name="id">
							<table>
								<tr>
									<td class="tdFirstTitle">借款金额（万元）</td>
									<td class="tdFirstContent">
										<input class="easyui-numberbox" style="width:100%" name="amount"
											   data-options="required:true,min:0,precision:4">
									</td>
								</tr>
								<tr>
									<td class="tdFirstTitle">借款利率</td>
									<td class="tdFirstContent">
										<input class="easyui-numberbox" name="rate" style="width:100%" data-options="required:true">
									</td>
								</tr>
								<tr>
									<td class="tdFirstTitle">借款日期</td>
									<td class="tdFirstContent">
										<input class="easyui-datebox" name="beginDate" style="width:100%" data-options="required:true,editable:false">
									</td>
								</tr>
								<tr>
									<td class="tdFirstTitle">预计还款日期</td>
									<td class="tdFirstContent">
										<input class="easyui-datebox" name="estimateRepayDate" style="width:100%"
											   data-options="required:true,editable:false">
									</td>
								</tr>
								<tr>
									<td class="tdFirstTitle">预计借款天数</td>
									<td class="tdFirstContent">
										<input class="easyui-numberbox" style="width:100%" name="estimateLoanDay"
											   data-options="required:true,min:1">
									</td>
								</tr>
								<tr>
									<td class="tdFirstTitle">预计利息（元）</td>
									<td class="tdFirstContent">
										<input class="easyui-numberbox" style="width:100%" name="estimateInterest"
											   data-options="required:true,precision:2,min:0">
									</td>
								</tr>
								<tr>
									<td class="tdFirstTitle">还款日期</td>
									<td class="tdFirstContent">
										<input class="easyui-datebox" style="width:100%" name="repayDate"
											   data-options="required:true,editable:false">
									</td>
								</tr>
								<tr>
									<td class="tdFirstTitle">借款天数</td>
									<td class="tdFirstContent">
										<input class="easyui-numberbox" style="width:100%" name="loanDay"
											   data-options="required:true,min:1">
									</td>
								</tr>
								<tr>
									<td class="tdFirstTitle">利息（元）</td>
									<td class="tdFirstContent">
										<input class="easyui-numberbox" style="width:100%" name="interest"
											   data-options="required:true,precision:2,min:0">
									</td>
								</tr>
								<tr>
									...
									<td class="tdFirstContent">
										<input class="easyui-numberbox" style="width:100%" name="receiveAmount"
											   data-options="precision:2,min:0">
									</td>
								</tr>
								<tr>
									<td class="tdFirstTitle">已收金额（元）</td>
									<td class="tdFirstContent">
										<input class="easyui-numberbox" style="width:100%" name="receivedAmount"
											   data-options="precision:2,min:0">
									</td>
								</tr>
								<tr>
									<td class="tdFirstTitle">未收金额（元）</td>
									<td class="tdFirstContent">
										<input class="easyui-numberbox" style="width:100%" name="receivingAmount"
											   data-options="precision:2,min:0">
									</td>
								</tr>
							</table>
