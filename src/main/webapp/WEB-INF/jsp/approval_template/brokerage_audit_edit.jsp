...
<head>
  ...
  <script type="text/javascript" src="${ctx}/resources/js/approval_template/brokerage_audit_edit.js"></script>
  <script type="text/javascript">
	$(function () {
		brokerage_audit_edit.init();
	})
  </script>
  <style> 
	.spans{ color:#FF0000} 
	...
	<div id="modBDEditDialog">
		<form id="modBDForm" method="post">
            <table>
				...
				<tr>
					<td class="tdTitle"><span class="spans">*</span>参考值</td>
					<td class="tdContent">
						<input class="easyui-textbox contentInput" name="reference"  data-options="required:true" readonly="readonly">
					</td>
				</tr>
				<tr>
